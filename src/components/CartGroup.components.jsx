          ...
          <div className=" border-t border-neutral-950 mb-5">
            <div className="mt-3 flex justify-end gap-10">
              <div className=" ">
                ...
                <p className=" text-right font-mono font-semibold">{total.toFixed(2)}</p>
              </div>
              <div className="">
                <h1 className=" text-neutral-400">Tax(5%)</h1>
                <p className=" text-right text-xl font-mono font-semibold">{tax.toFixed(2)}</p>
              </div>
              <div className="">
                <h1 className=" text-neutral-400">Net Total($)</h1>
                <p className=" text-right text-2xl font-bold font-mono">{netTotal.toFixed(2)}</p>
              </div>
            </div>
          </div>

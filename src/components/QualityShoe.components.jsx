    ...
    <div className="hero min-h-screen lg:py-5 py-0">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          The Swoosh itself is slightly oversized, standing out in a
            glossy white against the matte Flyknit. Text elements—another
            signature of Abloh’s collaboration with Nike—are printed in black on
            the medial side of the shoe. These words, in Helvetica font, offer a
            clinical description of the model: "Off-White for Nike, Air
            VaporMax, Beaverton, Oregon USA," along with the year "2017."
          </p>
          <Link
            to={"/shop"}
